$(document).ready(function () {
    ...
    $.validator.addMethod("checkphone", function (value, element) {
        ...
        if ($length == 10) {
            ...
            //Viettel
            patt = new RegExp(/^032[0-9]{7}$/g);
            $result = $result == true ? $result : patt.test($format_string);
            patt = new RegExp(/^033[0-9]{7}$/g);
            $result = $result == true ? $result : patt.test($format_string);
            patt = new RegExp(/^034[0-9]{7}$/g);
            $result = $result == true ? $result : patt.test($format_string);
            patt = new RegExp(/^035[0-9]{7}$/g);
            $result = $result == true ? $result : patt.test($format_string);
            patt = new RegExp(/^036[0-9]{7}$/g);
            $result = $result == true ? $result : patt.test($format_string);
            patt = new RegExp(/^037[0-9]{7}$/g);
            $result = $result == true ? $result : patt.test($format_string);
            patt = new RegExp(/^038[0-9]{7}$/g);
            $result = $result == true ? $result : patt.test($format_string);
            patt = new RegExp(/^039[0-9]{7}$/g);
            $result = $result == true ? $result : patt.test($format_string);

            // MobiFone
            patt = new RegExp(/^070[0-9]{7}$/g);
            $result = $result == true ? $result : patt.test($format_string);
            patt = new RegExp(/^079[0-9]{7}$/g);
            $result = $result == true ? $result : patt.test($format_string);
            patt = new RegExp(/^078[0-9]{7}$/g);
            $result = $result == true ? $result : patt.test($format_string);
            patt = new RegExp(/^077[0-9]{7}$/g);
            $result = $result == true ? $result : patt.test($format_string);
            patt = new RegExp(/^076[0-9]{7}$/g);
            $result = $result == true ? $result : patt.test($format_string);

            //VinaPhone
            patt = new RegExp(/^081[0-9]{7}$/g);
            $result = $result == true ? $result : patt.test($format_string);
            patt = new RegExp(/^082[0-9]{7}$/g);
            $result = $result == true ? $result : patt.test($format_string);
            patt = new RegExp(/^083[0-9]{7}$/g);
            $result = $result == true ? $result : patt.test($format_string);
            patt = new RegExp(/^084[0-9]{7}$/g);
            $result = $result == true ? $result : patt.test($format_string);
            patt = new RegExp(/^085[0-9]{7}$/g);
            $result = $result == true ? $result : patt.test($format_string);

            //Gmobile
            patt = new RegExp(/^059[0-9]{7}$/g);
            $result = $result == true ? $result : patt.test($format_string);

            //Vietnamobile
            patt = new RegExp(/^056[0-9]{7}$/g);
            $result = $result == true ? $result : patt.test($format_string);
            patt = new RegExp(/^058[0-9]{7}$/g);
            $result = $result == true ? $result : patt.test($format_string);
        }
        /*else if ($length == 11) {
